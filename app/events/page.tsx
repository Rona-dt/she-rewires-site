...
export default async function EventsPage() {
  ...
  const linkedInEventPosts = linkedInPosts.filter((post) => post.type === "event")
      ...
      <section className="py-16">
        <div className="container text-center">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-lg text-md-onSurfaceVariant">
            Events are published on this site and synced with our LinkedIn updates.
          </p>
        </div>
      </section>
      <EventsListClient upcomingEvents={upcomingEvents} pastEvents={pastEvents} linkedInEventPosts={linkedInEventPosts} />
    </div>
  )
}
